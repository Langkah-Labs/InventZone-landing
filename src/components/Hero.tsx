...
export function Hero() {
  return (
    <Container className="pb-16 pt-12 text-center lg:pt-12">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-4xl xs:text-4xl">
        Scan, Identify, &nbsp;
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">Gain Insight</span>
        </span>
